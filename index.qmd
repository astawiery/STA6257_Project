...
when solved will give estimates of $\beta_i$. In this equation
$D_i=\partial\mu_i/\partial\beta^{\prime}$ and ${V_i}^{-1}$ is the
...
structure. [@wang2014generalized] According the Liang and Zeger, the
...
which arise often in applied sciences. [@Liang1986longitudinal] For
