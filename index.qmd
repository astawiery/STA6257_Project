...
The 'geepack' package in R was used to create a model using the same GLM equation using the each of the available correlation structures availabe in the package, independence, exchangeable, unstructured and AR1.
